...
export const NODE_AREAS = {
  '0.1': null, // ETAP 0 — globus, bez poligonów na mapie

  // ETAP 1 — tablica ogłoszeń + stół (dwa osobne poligony)
  '1.x': [
    [ // tablica ogłoszeń
  ...
  '2.3': [[{x:127,y:563},{x:124,y:554},{x:119,y:546},{x:116,y:539},{x:110,y:539},{x:102,y:537},{x:92,y:536},{x:84,y:536},{x:74,y:539},{x:69,y:543},{x:64,y:544},{x:56,y:544},{x:55,y:554},{x:62,y:581},{x:64,y:588},{x:74,y:595},{x:89,y:598},{x:101,y:599},{x:113,y:595},{x:120,y:588},{x:127,y:580},{x:131,y:575}]],
  '2.4': [[{x:127,y:563},{x:124,y:554},{x:119,y:546},{x:116,y:539},{x:110,y:539},{x:102,y:537},{x:92,y:536},{x:84,y:536},{x:74,y:539},{x:69,y:543},{x:64,y:544},{x:56,y:544},{x:55,y:554},{x:62,y:581},{x:64,y:588},{x:74,y:595},{x:89,y:598},{x:101,y:599},{x:113,y:595},{x:120,y:588},{x:127,y:580},{x:131,y:575}]],
  ...
  '5.3': [ // dwa osobne poligony: latryna + dół chłonny
    [{x:732,y:1013},{x:708,y:1024},{x:692,y:1037},{x:697,y:1038},{x:697,y:1081},{x:722,y:1092},{x:745,y:1080},{x:744,y:1043},{x:750,y:1038}],
    [{x:687,y:1086},{x:730,y:1106},{x:730,y:1117},{x:691,y:1138},{x:649,y:1118},{x:648,y:1108}],
  ],
