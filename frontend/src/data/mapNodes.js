 ...
 * Węzły = klikalne obszary (poligony z pickera współrzędnych).
 * Ścieżki = rzeczywiste linie złożone z wielu punktów.
 */

// ── Obszary klikalne (poligony) ──────────────────────────────────────────────

export const NODE_AREAS = {
  // ETAP 0 — globus (brak obszaru na mapie, obsługiwany osobno)
  '0.1': null,

  // ETAP 1 — tablica ogłoszeń (JEDEN obszar dla wszystkich 1.x)
  '1.x': [
  ...
  // ETAP 2 — załączniki PSP (osobne obszary z lewej)
  '2.1': [
    {x:82,y:383},{x:95,y:386},{x:108,y:397},{x:113,y:415},{x:104,y:433},{x:92,y:441},{x:80,y:443},{x:70,y:441},{x:60,y:436},{x:54,y:428},{x:51,y:417},{x:52,y:402},{x:54,y:393},{x:68,y:387},
  ],
  '2.2': [
    {x:101,y:472},{x:85,y:462},{x:71,y:462},{x:54,y:473},{x:48,y:490},{x:52,y:508},{x:64,y:519},{x:79,y:522},{x:90,y:520},{x:99,y:514},{x:105,y:505},{x:109,y:493},{x:107,y:484},
  ],
  '2.3': [
    {x:127,y:563},{x:124,y:554},{x:119,y:546},{x:116,y:539},{x:110,y:539},{x:102,y:537},{x:92,y:536},{x:84,y:536},{x:74,y:539},{x:69,y:543},{x:64,y:544},{x:56,y:544},{x:55,y:554},{x:62,y:581},{x:64,y:588},{x:74,y:595},{x:89,y:598},{x:101,y:599},{x:113,y:595},{x:120,y:588},{x:127,y:580},{x:131,y:575},
  ],
  '2.4': [ // te same mapy co 2.3 — współdzielony obszar
    {x:127,y:563},{x:124,y:554},{x:119,y:546},{x:116,y:539},{x:110,y:539},{x:102,y:537},{x:92,y:536},{x:84,y:536},{x:74,y:539},{x:69,y:543},{x:64,y:544},{x:56,y:544},{x:55,y:554},{x:62,y:581},{x:64,y:588},{x:74,y:595},{x:89,y:598},{x:101,y:599},{x:113,y:595},{x:120,y:588},{x:127,y:580},{x:131,y:575},
  ],
  '2.5': [
    {x:174,y:629},{x:168,y:615},{x:151,y:605},{x:132,y:605},{x:119,y:612},{x:112,y:621},{x:107,y:638},{x:112,y:649},{x:117,y:658},{x:126,y:663},{x:139,y:668},{x:153,y:665},{x:164,y:659},{x:171,y:653},{x:176,y:642},
  ],

  // ETAP 3 — PSP
  '3.1': [
    {x:481,y:634},{x:469,y:630},{x:467,y:627},{x:427,y:609},{x:422,y:610},{x:411,y:607},{x:411,y:587},{x:399,y:580},{x:389,y:579},{x:385,y:584},{x:382,y:523},{x:367,y:520},{x:368,y:507},{x:377,y:508},{x:387,y:503},{x:387,y:535},{x:408,y:523},{x:411,y:517},{x:415,y:515},{x:421,y:516},{x:468,y:490},{x:472,y:493},{x:507,y:487},{x:538,y:521},{x:542,y:523},{x:543,y:601},{x:520,y:615},{x:525,y:616},{x:536,y:611},{x:541,y:611},{x:548,y:613},{x:548,y:615},{x:553,y:620},{x:556,y:630},{x:555,y:644},{x:551,y:650},{x:544,y:652},{x:538,y:657},{x:534,y:654},{x:517,y:665},{x:515,y:670},{x:508,y:671},{x:499,y:675},{x:487,y:671},{x:477,y:664},{x:476,y:657},{x:478,y:647},{x:475,y:640},
  ],

  // ETAP 4 — Kuratorium
  '4.1': [
    {x:365,y:857},{x:306,y:834},{x:306,y:830},{x:311,y:823},{x:302,y:825},{x:296,y:824},{x:287,y:823},{x:282,y:816},{x:281,y:809},{x:286,y:803},{x:289,y:755},{x:283,y:750},{x:327,y:719},{x:333,y:718},{x:338,y:715},{x:348,y:714},{x:350,y:722},{x:372,y:729},{x:386,y:719},{x:414,y:710},{x:441,y:740},{x:438,y:751},{x:475,y:768},{x:472,y:775},{x:473,y:824},{x:468,y:830},{x:475,y:829},{x:481,y:833},{x:485,y:838},{x:488,y:845},{x:485,y:851},{x:475,y:853},{x:475,y:854},{x:467,y:856},{x:459,y:861},{x:449,y:861},{x:444,y:851},{x:427,y:859},{x:417,y:858},{x:412,y:862},{x:404,y:864},{x:394,y:861},{x:382,y:855},{x:377,y:851},
  ],
  '4.2': [
    {x:115,y:770},{x:99,y:775},{x:81,y:784},{x:69,y:800},{x:67,y:826},{x:76,y:847},{x:91,y:859},{x:114,y:869},{x:137,y:870},{x:153,y:862},{x:172,y:848},{x:177,y:833},{x:181,y:809},{x:173,y:791},{x:149,y:776},
  ],
  '4.3': [
    {x:268,y:881},{x:250,y:869},{x:230,y:861},{x:205,y:864},{x:181,y:874},{x:170,y:886},{x:165,y:903},{x:165,y:920},{x:180,y:939},{x:201,y:948},{x:224,y:953},{x:248,y:946},{x:267,y:934},{x:277,y:916},{x:275,y:899},
  ],

  // ETAP 5 — pozostałe (prawa strona)
  '5.1': [
    {x:570,y:909},{x:572,y:919},{x:569,y:920},{x:569,y:945},{x:531,y:965},{x:498,y:950},{x:499,y:926},{x:496,y:924},{x:496,y:916},{x:537,y:894},
  ],
  '5.2': [
    {x:702,y:894},{x:702,y:901},{x:699,y:902},{x:700,y:942},{x:662,y:965},{x:613,y:942},{x:614,y:901},{x:612,y:899},{x:613,y:892},{x:653,y:871},
  ],
  '5.3': [ // latryna + dół chłonny
...
// Mapowanie node ID → area ID (dla węzłów które dzielą obszar)
export const NODE_TO_AREA = {
  '1.1': '1.x', '1.2': '1.x', '1.3': '1.x', '1.4': '1.x', '1.5': '1.x',
  '6.1': '6.x', '6.2': '6.x', '6.3': '6.x', '6.4': '6.x',
}

// ── Ścieżki (rzeczywiste punkty) ─────────────────────────────────────────────
// Każda ścieżka to array of {x,y}

export const REAL_PATHS = [
  // Ścieżka główna (ETAP 0 → 1 → 3 → 4 → 6)
  {
    id: 'main',
    points: [
  ...
  // ETAP 2 — załączniki → PSP
  {
    id: 'psp-branch',
    points: [
      {x:93,y:442},{x:91,y:433},{x:102,y:452},{x:116,y:454},{x:134,y:461},{x:137,y:472},{x:129,y:482},{x:117,y:488},{x:99,y:492},{x:97,y:501},{x:106,y:508},{x:115,y:513},{x:126,y:519},{x:136,y:527},{x:143,y:534},{x:145,y:549},{x:148,y:560},{x:152,y:573},{x:163,y:583},{x:175,y:593},{x:190,y:599},{x:207,y:604},{x:220,y:605},{x:230,y:605},{x:243,y:604},{x:259,y:607},{x:275,y:614},{x:290,y:622},{x:310,y:626},{x:322,y:623},{x:337,y:619},{x:371,y:609},
    ],
  },
  {
    id: 'psp-branch2',
    points: [
      {x:244,y:611},{x:246,y:604},{x:232,y:624},{x:212,y:635},{x:188,y:640},{x:163,y:638},
    ],
  },
  {
    id: 'psp-branch3',
    points: [
      {x:116,y:566},{x:150,y:572},
    ],
  },

  // ETAP 4 — poboczne → Kuratorium
  {
    id: 'kuratorium-branch1',
    points: [
      {x:174,y:827},{x:210,y:825},{x:240,y:833},{x:262,y:844},{x:286,y:852},{x:308,y:856},{x:333,y:846},
    ],
  },
  {
    id: 'kuratorium-branch2',
    points: [
      {x:267,y:894},{x:289,y:886},{x:305,y:872},{x:325,y:857},{x:334,y:846},
    ],
  },

  // ETAP 5 — poboczne → główna ścieżka do obozu
  {
    id: 'side-to-camp',
    points: [
      {x:632,y:952},{x:610,y:962},{x:595,y:978},{x:587,y:992},{x:596,y:1008},{x:620,y:1023},{x:631,y:1035},{x:639,y:1049},{x:637,y:1070},{x:628,y:1087},{x:611,y:1096},{x:595,y:1110},{x:573,y:1117},{x:555,y:1127},{x:552,y:1138},
    ],
  },
  {
    id: 'police-to-camp',
    points: [
      {x:560,y:950},{x:580,y:962},{x:591,y:978},
    ],
  },
  {
    id: 'water-to-camp',
    points: [
      {x:691,y:992},{x:671,y:1002},{x:639,y:1017},{x:631,y:1034},
    ],
  },
  {
    id: 'latrine-to-camp',
    points: [
      {x:697,y:1073},{x:672,y:1074},{x:640,y:1081},{x:627,y:1088},
    ],
  },
]

// ── Centra obszarów (obliczane) ─────────────────────────────────────────────
...
// Cache centrów
const _centers = {}
function getCenter(areaId) {
  if (!_centers[areaId]) {
    _centers[areaId] = computeCenter(NODE_AREAS[areaId])
  }
  return _centers[areaId]
}

// Pozycja ludzika dla danego node ID
export function getCharPosition(nodeId) {
  const areaId = NODE_TO_AREA[nodeId] || nodeId
  if (!NODE_AREAS[areaId]) return { x: 200, y: 100 }
  return getCenter(areaId)
}

// Sprawdź czy punkt (x,y) jest wewnątrz poligonu
...
export const NODE_DETAIL_IMAGE_KEY = {
  ...
  '3.1': 'detale-psp',
  '4.1': 'detale-kuratorium', '4.2': 'detale-kuratorium', '4.3': 'detale-kuratorium',
  '5.x': 'detale-ogolny',
  '6.x': 'detale-ogolny',
}
...
// Wszystkie ID węzłów (na potrzeby useMapState)
